...
?>
	...
	<div class="table-cell product_name">
...
<!--								</dt>-->
								<div class="table-cell" <?=(!isset($item['PROPERTY_CODE_MOBILE'][$code]) ? ' class="hidden-xs table-cell"' : '')?>>
...
<!--								--><?//=$skuProperty['NAME']?>
	...
	?>
			...
			foreach ($arParams['PRODUCT_BLOCKS_ORDER'] as $blockName)
			{
				...
				{
					case 'price': ?>
						<div class="product-item-info-container product-item-price-container table-cell" style="<?if ($arParams['SHOW_OLD_PRICE'] === 'Y')
                        { echo 'min-width: 130px';}; ?>"
							...
							<span class="product-item-price-current " id="<?=$itemIds['PRICE']?>">
								...
								?>
                                  ...
                                  <? foreach ($item['PRICES'] as $key => $prices) {
                                      if ($key != 'BASE') {
                                      ?>
                                          <div class="table-cell"><? echo $prices['VALUE'];?></div>
                                  <?  }
                                  }
                        ?>
						<?
					...
					case 'quantityLimit':
						if ($arParams['SHOW_MAX_QUANTITY'] !== 'N')
						{
							...
							else
							{
								...
								{
									?>
									<div class="product-item-info-container table-cell" id="<?=$itemIds['QUANTITY_LIMIT']?>">
										<div class="product-item-info-container-title">
<!--											--><?//=$arParams['MESS_SHOW_MAX_QUANTITY']?><!--:-->
                        ...
                        $APPLICATION->IncludeComponent(
                            ...
                            Array(
                                ...
                                "ELEMENT_CODE" => "",
                                "ELEMENT_ID" => $item['ID'],
                                "FIELDS" => array("TITLE", "ADDRESS", "DESCRIPTION", "PHONE", "EMAIL", "IMAGE_ID", "COORDINATES", "SCHEDULE", ""),
                                "IBLOCK_ID" => "2",
                                "IBLOCK_TYPE" => "catalog",
                                "MAIN_TITLE" => "",
                                "MIN_AMOUNT" => "0",
                    ...
                    case 'quantity':
                        ...
                        if (!$haveOffers)
                        {
                            ...
                            {
                                ?>
                                <div class="product-item-info-container table-cell" data-entity="quantity-block">
                    ...
                    case 'buttons':
                        ...
                        ?>
                        <div class="product-item-info-container table-cell" data-entity="buttons-block">
                            <?
                            if (!$haveOffers)
                            {
